...
export class ServiceAuthGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    // Support both /api/auth/* and /api-auth/v1/auth/* paths
    const publicPaths: string[] = [
      ...
      // Paths with /api-auth/v1/ prefix
      '/api-auth/v1/auth/register',
      '/api-auth/v1/auth/login',
      '/api-auth/v1/auth/verify',
      '/api-auth/v1/auth/refresh',
      '/api-auth/v1/auth/password-reset/request',
      '/api-auth/v1/auth/password-reset/verify',
      '/api-auth/v1/auth/password-reset/confirm',
      '/api-auth/v1/auth/2fa/verify',
      '/api-auth/v1/auth/phone-otp/send',
      '/api-auth/v1/auth/phone-otp/verify',
      '/api-auth/v1/auth/email-verification/send',
      '/api-auth/v1/auth/email-verification/verify',
      '/api-auth/v1/auth/email-verification/resend',
      '/api-auth/v1/auth/oauth/google',
      '/api-auth/v1/auth/oauth/google/callback',
      '/api-auth/v1/auth/oauth/github',
      '/api-auth/v1/auth/oauth/github/callback',
      '/api-auth/v1/auth/oauth/apple',
      '/api-auth/v1/auth/oauth/apple/callback',
    ];
