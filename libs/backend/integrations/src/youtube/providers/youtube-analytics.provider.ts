...
} from '../../../e-commerce/video-commerce/youtube/src/constants/youtube.constants';
import {
  AudienceMetric,
  isAudienceMetric,
  isVideoMetrics,
...
} from '../../../e-commerce/video-commerce/youtube/src/types/youtube-api-types';
import type { RetentionDataPoint } from '../../analytics/interfaces/analytics.interface';
import { YouTubeAnalyticsService } from '../services/youtube-analytics.service';
import { FileStream, YouTubeApiService } from '../services/youtube-api.service';
        ...
        if (Array.isArray(retentionDataRaw) && retentionDataRaw.length > 0) {
          ...
          for (const item of retentionDataRaw) {
            if (
              ...
              retentionData.push(item as RetentionDataPoint);
            }
          }
